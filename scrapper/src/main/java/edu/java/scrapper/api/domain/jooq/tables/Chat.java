...
package edu.java.scrapper.api.domain.jooq.tables;

import edu.java.scrapper.api.domain.jooq.DefaultSchema;
import edu.java.scrapper.api.domain.jooq.Keys;
...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The column <code>CHAT.TG_ID</code>.
     */
    public final TableField<ChatRecord, Long> TG_ID = createField(DSL.name("TG_ID"), SQLDataType.BIGINT, this, "");
