...
package edu.java.scrapper.api.domain.jooq.tables.records;
...
public class ChatRecord extends UpdatableRecordImpl<ChatRecord> implements Record2<Long, Long> {
    ...
    public ChatRecord(@Nullable Long id, @Nullable Long tgId) {
        super(Chat.CHAT);
     ...
     * Create a detached, initialised ChatRecord
     */
    public ChatRecord(edu.java.scrapper.api.domain.jooq.tables.pojos.Chat value) {
        super(Chat.CHAT);
